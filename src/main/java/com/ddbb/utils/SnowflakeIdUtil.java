...
/**
 * 原文链接：https://blog.csdn.net/xxj_jing/article/details/143156669
 */
public class SnowflakeIdUtil {
    ...
    private int getWorkId() {
        try {
            ...
            String hostAddress = hostname+ip;
    ...
    public synchronized long nextId() {
        ...
        if (now < lastTimestamp) {
            ...
            if (offset <= 1500) {
                ...
                throw new RuntimeException(String.format("时钟回拨，无法生成ID %d milliseconds", offset));
            }
        }
        // 如果是同一时间生成的，则进行毫秒内序列
