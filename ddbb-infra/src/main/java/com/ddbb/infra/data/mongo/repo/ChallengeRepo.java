...
public class ChallengeRepo extends MongoBaseRepository<ChallengeEntity> {
     ...
     * @return
     */
    public List<ChallengeEntity> getAllChallengeByDate(Long uid, String dateStr){
        Criteria criteria = Criteria.where("owner").is(uid).and("challengeDateStr").is(dateStr);
     ...
     * @return
     */
    public List<ChallengeEntity> getReceivedChallengeByDate(Long uid, String dateStr){
        Criteria criteria = Criteria.where("owner").is(uid).and("to").is(uid).and("challengeDateStr").is(dateStr);
        List<ChallengeEntity> all = findAll(criteria);
        return all;
    }
    /**
     ...
     * @return
     */
    public List<ChallengeEntity> getLaunchedChallengeByDate(Long uid, String dateStr){
        Criteria criteria = Criteria.where("owner").is(uid).and("from").is(uid).and("challengeDateStr").is(dateStr);
        List<ChallengeEntity> all = findAll(criteria);
        return all;
    }
     ...
     * @return
     */
    public List<ChallengeEntity> getAllTodayAndAfterChallenge(Long uid){
        int today = DateUtilPlus.getCurrentDateInt();
        Criteria criteria = Criteria.where("owner").is(uid).and("challengeDateInt").gte(today);
        List<ChallengeEntity> all = findAll(criteria);
        return all;
    }
    /**
     ...
     * @return
     */
    public List<ChallengeEntity> getLaunchedTodayAndAfterChallenge(Long uid){
        int today = DateUtilPlus.getCurrentDateInt();
        Criteria criteria = Criteria.where("owner").is(uid).and("from").is(uid).and("challengeDateInt").gte(today);
        List<ChallengeEntity> all = findAll(criteria);
        return all;
    }
     ...
     * @return
     */
    public List<ChallengeEntity> getReceivedTodayAndAfterChallenge(Long uid){
        int today = DateUtilPlus.getCurrentDateInt();
        Criteria criteria = Criteria.where("owner").is(uid).and("to").is(uid).and("challengeDateInt").gte(today);
        List<ChallengeEntity> all = findAll(criteria);
        return all;
    }
